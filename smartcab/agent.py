...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == True:
            ...
            #self.epsilon = math.pow(0.5,self.trials_num)

            #self.epsilon = 1 / float(math.pow(self.trials_num+1,2))

            self.epsilon = math.exp(-0.01 * self.trials_num)

            #self.epsilon = math.cos(0.5 * self.trials_num)
...
def run():
    ...
    #sim.run(n_test=100, tolerance=1)
